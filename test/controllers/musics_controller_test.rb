...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { album_id: @music.album_id, feat: @music.feat, release_date: @music.release_date, title: @music.title } }, as: :json
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { album_id: @music.album_id, feat: @music.feat, release_date: @music.release_date, title: @music.title } }, as: :json
    assert_response :success
  end
